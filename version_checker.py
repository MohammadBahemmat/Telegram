        ...
        try:
            ...
            if last_versions.get(repo_path) != latest_version_id:
                ...
                if "Desktop" in app_name: # For v2rayN repo
                    # CHANGE: Simplified logic for Windows and macOS
                    win_link_64 = find_asset_url(assets, ["windows-64.zip", "win-x64.zip"])
                    ...
                    # CHANGE: Simplified logic for Android
